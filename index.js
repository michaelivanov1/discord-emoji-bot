...
/*  to run:
    1) cd to root folder in CMD
    2) type: nodemon index.js
*/

const Discord = require('discord.js');
// client references the bot itself
...
// when new user joins
onUserJoin(client);
// private message user if triggerText triggered // bot, triggerText, replyText
privateMessage(client, 'test', 'get off me');
